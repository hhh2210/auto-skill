...
| `data/run_presentbench_material_digest.py` | Render selected PresentBench PDF pages and ask a multimodal Qwen/OpenAI-compatible model for structured material digests. | experimental/API |
